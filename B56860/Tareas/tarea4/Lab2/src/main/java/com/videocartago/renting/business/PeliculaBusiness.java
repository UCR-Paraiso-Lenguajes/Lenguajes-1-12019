...
public class PeliculaBusiness {
	...
	public List<Pelicula> findAllMoviesByTitle(String titulo) {
		return peliculaDao.findMoviesByTitle(titulo);
	}
	
	public Pelicula save(Pelicula pelicula) throws SQLException {
		if(pelicula == null ) throw new RuntimeException("La peli es requerida");
