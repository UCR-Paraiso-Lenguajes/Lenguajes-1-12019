...
namespace model.Data
{
    public class DepartamentosData
    {
        ...
        public List<Departamentos> LlenarDepartamentos()
        {
            ...
            Departamentos departamento1 = new Departamentos(1, "Asamblea de Socios");
        ...
        public void MetodoDeSeleccionado(int idDepartamento)
        {
            ...
            foreach (Departamentos depart in departamentos)
            {
                ...
                if (depart.IdDepartamento == idDepartamento && depart.Jefatura !=null)
                {
                    while (depart.Jefatura != null)
                    {
                        depart.Marcado = true;
                        depart.Jefatura = depart.Jefatura.Jefatura;

                    }
                    if (depart.Jefatura == null)
                    {
                        depart.Marcado = true;
                    }
                }
            ...
            foreach (Departamentos depart in departamentos)
                {
                    if (depart.IdDepartamento == idDepartamento)
                    {
                        while (depart.Jefatura != null)
                        {
                        depart.Marcado = true;
