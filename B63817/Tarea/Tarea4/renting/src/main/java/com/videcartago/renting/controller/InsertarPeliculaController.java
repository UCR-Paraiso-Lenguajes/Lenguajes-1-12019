...
public class InsertarPeliculaController {
	...
	{
		List<Genero> generos =  generoBusiness.findAll(1,9999);
	...
	public String save(@Valid PeliculaForm peliculaForm, BindingResult bindingResult, Model model) 
	{
		...
		else
		{
			...
			model.addAttribute("peliculas", peliculaBusiness.findAllMovieByTitleAndGenre(pelicula.getTitulo(), pelicula.getGenero().getNombreGenero()));
			return "findMovies";
		}
	}
