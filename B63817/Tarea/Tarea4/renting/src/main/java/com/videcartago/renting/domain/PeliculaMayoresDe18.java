...
public class PeliculaMayoresDe18 extends PeliculaFactory{

	public PeliculaMayoresDe18(String sipnosis, int codPelicula, String titulo, int totalPeliculas, boolean subtitulada,
