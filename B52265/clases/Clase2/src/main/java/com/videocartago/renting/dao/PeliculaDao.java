package com.videocartago.renting.dao;
...
public class PeliculaDao {
	...
	public List<Pelicula> findMoviesByTittleAndGenre(String titulo, String genero) {
		String sqlSelect = "SELECT p.cod_pelicula, p.titulo, p.cod_genero, g.nombre_genero, p.total_peliculas,p.subtitulada, "
				+ "p.estreno, pa.cod_actor, a.nombre_actor, a.apellidos_actor"
				...
				+ "left join Actor a on pa.cod_actor = a.cod_actor" + "WHERE p.titulo like '%" + titulo.trim()
				+ "%' and g.nombre_genero like '%" + genero.trim() + "%'";
