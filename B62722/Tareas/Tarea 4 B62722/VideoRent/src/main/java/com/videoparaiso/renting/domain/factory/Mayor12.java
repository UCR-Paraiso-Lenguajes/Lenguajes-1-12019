...
public class Mayor12 extends PeliculaFactory {

	public Mayor12() {
		super();
	}

	public Mayor12(int codPelicula, String titulo, int totalPeliculas, boolean subtitulada, boolean estreno, Genero genero, List<Actor> actores) {
