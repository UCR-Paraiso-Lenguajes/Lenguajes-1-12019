...
public class PeliculaData {
	...
	public void rentar(Pelicula pelicula) {
		if (estadoPelicula instanceof Rentada) {
			throw new RuntimeException("La película ya se encuentra rentada.");
		} else {
	...
	public void devolver(Pelicula pelicula) {
		if (estadoPelicula instanceof Disponible) {
			throw new RuntimeException("La película no se puede devolver.");
		} else {
			pelicula.setEstado(new Disponible());
			estadoPelicula.Estado();
		}
	}
}
